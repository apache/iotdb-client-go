...
var knownTConsensusGroupTypeValues = []TConsensusGroupType{
	TConsensusGroupType_ConfigRegion,
	TConsensusGroupType_DataRegion,
	TConsensusGroupType_SchemaRegion,
}

func TConsensusGroupTypeValues() iter.Seq[TConsensusGroupType] {
	return func(yield func(TConsensusGroupType) bool) {
		for _, v := range knownTConsensusGroupTypeValues {
			if !yield(v) {
				return
			}
		}
...
var knownTRegionMigrateFailedTypeValues = []TRegionMigrateFailedType{
	TRegionMigrateFailedType_AddPeerFailed,
	TRegionMigrateFailedType_RemovePeerFailed,
	TRegionMigrateFailedType_RemoveConsensusGroupFailed,
	TRegionMigrateFailedType_DeleteRegionFailed,
	TRegionMigrateFailedType_CreateRegionFailed,
	TRegionMigrateFailedType_Disconnect,
}

func TRegionMigrateFailedTypeValues() iter.Seq[TRegionMigrateFailedType] {
	return func(yield func(TRegionMigrateFailedType) bool) {
		for _, v := range knownTRegionMigrateFailedTypeValues {
			if !yield(v) {
				return
			}
		}
...
var knownTRegionMaintainTaskStatusValues = []TRegionMaintainTaskStatus{
	TRegionMaintainTaskStatus_TASK_NOT_EXIST,
	TRegionMaintainTaskStatus_PROCESSING,
	TRegionMaintainTaskStatus_SUCCESS,
	TRegionMaintainTaskStatus_FAIL,
}

func TRegionMaintainTaskStatusValues() iter.Seq[TRegionMaintainTaskStatus] {
	return func(yield func(TRegionMaintainTaskStatus) bool) {
		for _, v := range knownTRegionMaintainTaskStatusValues {
			if !yield(v) {
				return
			}
		}
...
var knownThrottleTypeValues = []ThrottleType{
	ThrottleType_REQUEST_NUMBER,
	ThrottleType_REQUEST_SIZE,
	ThrottleType_WRITE_NUMBER,
	ThrottleType_WRITE_SIZE,
	ThrottleType_READ_NUMBER,
	ThrottleType_READ_SIZE,
}

func ThrottleTypeValues() iter.Seq[ThrottleType] {
	return func(yield func(ThrottleType) bool) {
		for _, v := range knownThrottleTypeValues {
			if !yield(v) {
				return
			}
		}
...
var knownTServiceTypeValues = []TServiceType{
	TServiceType_ConfigNodeInternalService,
	TServiceType_DataNodeInternalService,
	TServiceType_DataNodeMPPService,
	TServiceType_DataNodeExternalService,
}

func TServiceTypeValues() iter.Seq[TServiceType] {
	return func(yield func(TServiceType) bool) {
		for _, v := range knownTServiceTypeValues {
			if !yield(v) {
				return
			}
		}
...
const (
	...
	TAggregationType_APPROX_PERCENTILE TAggregationType = 32
	TAggregationType_CORR TAggregationType = 33
	TAggregationType_COVAR_POP TAggregationType = 34
	TAggregationType_COVAR_SAMP TAggregationType = 35
	TAggregationType_REGR_SLOPE TAggregationType = 36
	TAggregationType_REGR_INTERCEPT TAggregationType = 37
...
var knownTAggregationTypeValues = []TAggregationType{
	TAggregationType_COUNT,
	TAggregationType_AVG,
	TAggregationType_SUM,
	TAggregationType_FIRST_VALUE,
	TAggregationType_LAST_VALUE,
	TAggregationType_MAX_TIME,
	TAggregationType_MIN_TIME,
	TAggregationType_MAX_VALUE,
	TAggregationType_MIN_VALUE,
	TAggregationType_EXTREME,
	TAggregationType_COUNT_IF,
	TAggregationType_TIME_DURATION,
	TAggregationType_MODE,
	TAggregationType_COUNT_TIME,
	TAggregationType_STDDEV,
	TAggregationType_STDDEV_POP,
	TAggregationType_STDDEV_SAMP,
	TAggregationType_VARIANCE,
	TAggregationType_VAR_POP,
	TAggregationType_VAR_SAMP,
	TAggregationType_MAX_BY,
	TAggregationType_MIN_BY,
	TAggregationType_UDAF,
	TAggregationType_FIRST,
	TAggregationType_LAST,
	TAggregationType_FIRST_BY,
	TAggregationType_LAST_BY,
	TAggregationType_MIN,
	TAggregationType_MAX,
	TAggregationType_COUNT_ALL,
	TAggregationType_APPROX_COUNT_DISTINCT,
	TAggregationType_APPROX_MOST_FREQUENT,
	TAggregationType_APPROX_PERCENTILE,
	TAggregationType_CORR,
	TAggregationType_COVAR_POP,
	TAggregationType_COVAR_SAMP,
	TAggregationType_REGR_SLOPE,
	TAggregationType_REGR_INTERCEPT,
...
func TAggregationTypeValues() iter.Seq[TAggregationType] {
	return func(yield func(TAggregationType) bool) {
		for _, v := range knownTAggregationTypeValues {
			if !yield(v) {
				return
			}
		}
...
func (p TAggregationType) String() string {
	...
	case TAggregationType_APPROX_PERCENTILE: return "APPROX_PERCENTILE"
	case TAggregationType_CORR: return "CORR"
	case TAggregationType_COVAR_POP: return "COVAR_POP"
	case TAggregationType_COVAR_SAMP: return "COVAR_SAMP"
	case TAggregationType_REGR_SLOPE: return "REGR_SLOPE"
	case TAggregationType_REGR_INTERCEPT: return "REGR_INTERCEPT"
...
func TAggregationTypeFromString(s string) (TAggregationType, error) {
	...
	case "APPROX_PERCENTILE": return TAggregationType_APPROX_PERCENTILE, nil
	case "CORR": return TAggregationType_CORR, nil
	case "COVAR_POP": return TAggregationType_COVAR_POP, nil
	case "COVAR_SAMP": return TAggregationType_COVAR_SAMP, nil
	case "REGR_SLOPE": return TAggregationType_REGR_SLOPE, nil
	case "REGR_INTERCEPT": return TAggregationType_REGR_INTERCEPT, nil
...
var knownTrainingStateValues = []TrainingState{
	TrainingState_PENDING,
	TrainingState_RUNNING,
	TrainingState_FINISHED,
	TrainingState_FAILED,
	TrainingState_DROPPING,
}

func TrainingStateValues() iter.Seq[TrainingState] {
	return func(yield func(TrainingState) bool) {
		for _, v := range knownTrainingStateValues {
			if !yield(v) {
				return
			}
		}
...
var knownModelValues = []Model{
	Model_TREE,
	Model_TABLE,
}

func ModelValues() iter.Seq[Model] {
	return func(yield func(Model) bool) {
		for _, v := range knownModelValues {
			if !yield(v) {
				return
			}
		}
...
var knownFunctionTypeValues = []FunctionType{
	FunctionType_NONE,
	FunctionType_SCALAR,
	FunctionType_AGGREGATE,
	FunctionType_TABLE,
}

func FunctionTypeValues() iter.Seq[FunctionType] {
	return func(yield func(FunctionType) bool) {
		for _, v := range knownFunctionTypeValues {
			if !yield(v) {
				return
			}
		}
...
func (p *TEndPoint) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TEndPoint",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TEndPoint)(nil)

func (p *TEndPoint) Validate() error {
	return nil
}
...
type TSStatus struct {
	...
	ResponseData []byte `thrift:"responseData,6" db:"responseData" json:"responseData,omitempty"`
}
...
var TSStatus_ResponseData_DEFAULT []byte


func (p *TSStatus) GetResponseData() []byte {
...
func (p *TSStatus) IsSetResponseData() bool {
...
func (p *TSStatus) ReadField6(ctx context.Context, iprot thrift.TProtocol) error {
...
func (p *TSStatus) writeField6(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if p.IsSetResponseData() {
		if err := oprot.WriteFieldBegin(ctx, "responseData", thrift.STRING, 6); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 6:responseData: ", p), err)
		}
		if err := oprot.WriteBinary(ctx, p.ResponseData); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T.responseData (6) field write error: ", p), err)
		}
		if err := oprot.WriteFieldEnd(ctx); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field end error 6:responseData: ", p), err)
		}
	}
	return err
}
...
func (p *TSStatus) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TSStatus",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TSStatus)(nil)

func (p *TSStatus) Validate() error {
	return nil
}
...
func (p *TConsensusGroupId) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TConsensusGroupId",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TConsensusGroupId)(nil)

func (p *TConsensusGroupId) Validate() error {
	return nil
}
...
func (p *TSeriesPartitionSlot) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TSeriesPartitionSlot",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TSeriesPartitionSlot)(nil)

func (p *TSeriesPartitionSlot) Validate() error {
	return nil
}
...
func (p *TTimePartitionSlot) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TTimePartitionSlot",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TTimePartitionSlot)(nil)

func (p *TTimePartitionSlot) Validate() error {
	return nil
}
...
func (p *TRegionReplicaSet) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TRegionReplicaSet",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TRegionReplicaSet)(nil)

func (p *TRegionReplicaSet) Validate() error {
	return nil
}
...
func (p *TNodeResource) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TNodeResource",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TNodeResource)(nil)

func (p *TNodeResource) Validate() error {
	return nil
}
...
func (p *TConfigNodeLocation) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TConfigNodeLocation",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TConfigNodeLocation)(nil)

func (p *TConfigNodeLocation) Validate() error {
	return nil
}
...
func (p *TDataNodeLocation) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TDataNodeLocation",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TDataNodeLocation)(nil)

func (p *TDataNodeLocation) Validate() error {
	return nil
}
...
func (p *TAINodeLocation) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TAINodeLocation",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TAINodeLocation)(nil)

func (p *TAINodeLocation) Validate() error {
	return nil
}
...
func (p *TDataNodeConfiguration) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TDataNodeConfiguration",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TDataNodeConfiguration)(nil)

func (p *TDataNodeConfiguration) Validate() error {
	return nil
}
...
func (p *TAINodeConfiguration) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TAINodeConfiguration",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TAINodeConfiguration)(nil)

func (p *TAINodeConfiguration) Validate() error {
	return nil
}
...
func (p *TFlushReq) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TFlushReq",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TFlushReq)(nil)

func (p *TFlushReq) Validate() error {
	return nil
}
...
func (p *TSettleReq) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TSettleReq",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TSettleReq)(nil)

func (p *TSettleReq) Validate() error {
	return nil
}
...
func (p *TSchemaNode) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TSchemaNode",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TSchemaNode)(nil)

func (p *TSchemaNode) Validate() error {
	return nil
}
...
func (p *TSetConfigurationReq) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TSetConfigurationReq",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TSetConfigurationReq)(nil)

func (p *TSetConfigurationReq) Validate() error {
	return nil
}
...
func (p *TSetTTLReq) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TSetTTLReq",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TSetTTLReq)(nil)

func (p *TSetTTLReq) Validate() error {
	return nil
}
...
func (p *TShowTTLReq) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TShowTTLReq",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TShowTTLReq)(nil)

func (p *TShowTTLReq) Validate() error {
	return nil
}
...
func (p *TFile) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
...
var _ slog.LogValuer = (*TFile)(nil)

func (p *TFile) Validate() error {
	return nil
}
...
func (p *TFilesResp) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TFilesResp",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TFilesResp)(nil)

func (p *TFilesResp) Validate() error {
	return nil
}
...
func (p *TSpaceQuota) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TSpaceQuota",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TSpaceQuota)(nil)

func (p *TSpaceQuota) Validate() error {
	return nil
}
...
func (p *TTimedQuota) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TTimedQuota",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TTimedQuota)(nil)

func (p *TTimedQuota) Validate() error {
	return nil
}
...
func (p *TThrottleQuota) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TThrottleQuota",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TThrottleQuota)(nil)

func (p *TThrottleQuota) Validate() error {
	return nil
}
...
func (p *TSetSpaceQuotaReq) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TSetSpaceQuotaReq",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TSetSpaceQuotaReq)(nil)

func (p *TSetSpaceQuotaReq) Validate() error {
	return nil
}
...
func (p *TSetThrottleQuotaReq) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TSetThrottleQuotaReq",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TSetThrottleQuotaReq)(nil)

func (p *TSetThrottleQuotaReq) Validate() error {
	return nil
}
...
type TPipeHeartbeatResp struct {
	...
	PipeDegradedStatusList []int32 `thrift:"pipeDegradedStatusList,5" db:"pipeDegradedStatusList" json:"pipeDegradedStatusList,omitempty"`
	PipeRecentFailureList []map[string]int64 `thrift:"pipeRecentFailureList,6" db:"pipeRecentFailureList" json:"pipeRecentFailureList,omitempty"`
}
...
var TPipeHeartbeatResp_PipeDegradedStatusList_DEFAULT []int32


func (p *TPipeHeartbeatResp) GetPipeDegradedStatusList() []int32 {
...
func (p *TPipeHeartbeatResp) IsSetPipeDegradedStatusList() bool {
...
func (p *TPipeHeartbeatResp) ReadField5(ctx context.Context, iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin(ctx)
	if err != nil {
		return thrift.PrependError("error reading list begin: ", err)
	}
	tSlice := make([]int32, 0, size)
	p.PipeDegradedStatusList = tSlice
	for i := 0; i < size; i++ {
		var _elem28 int32
		if v, err := iprot.ReadI32(ctx); err != nil {
			return thrift.PrependError("error reading field 0: ", err)
		...
		p.PipeDegradedStatusList = append(p.PipeDegradedStatusList, _elem28)
	}
	if err := iprot.ReadListEnd(ctx); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *TPipeHeartbeatResp) ReadField6(ctx context.Context, iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin(ctx)
	if err != nil {
		return thrift.PrependError("error reading list begin: ", err)
	}
	...
	for i := 0; i < size; i++ {
		...
		p.PipeRecentFailureList = append(p.PipeRecentFailureList, _elem29)
	}
	if err := iprot.ReadListEnd(ctx); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *TPipeHeartbeatResp) writeField5(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if p.IsSetPipeDegradedStatusList() {
		if err := oprot.WriteFieldBegin(ctx, "pipeDegradedStatusList", thrift.LIST, 5); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 5:pipeDegradedStatusList: ", p), err)
		}
		if err := oprot.WriteListBegin(ctx, thrift.I32, len(p.PipeDegradedStatusList)); err != nil {
			return thrift.PrependError("error writing list begin: ", err)
		}
		for _, v := range p.PipeDegradedStatusList {
		...
		if err := oprot.WriteFieldEnd(ctx); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field end error 5:pipeDegradedStatusList: ", p), err)
		}
	}
	return err
}

func (p *TPipeHeartbeatResp) writeField6(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if p.IsSetPipeRecentFailureList() {
		if err := oprot.WriteFieldBegin(ctx, "pipeRecentFailureList", thrift.LIST, 6); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 6:pipeRecentFailureList: ", p), err)
		}
		if err := oprot.WriteListBegin(ctx, thrift.MAP, len(p.PipeRecentFailureList)); err != nil {
			return thrift.PrependError("error writing list begin: ", err)
		}
		...
		if err := oprot.WriteFieldEnd(ctx); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field end error 6:pipeRecentFailureList: ", p), err)
		}
	}
	return err
}
...
func (p *TPipeHeartbeatResp) Equals(other *TPipeHeartbeatResp) bool {
	...
	if len(p.PipeDegradedStatusList) != len(other.PipeDegradedStatusList) { return false }
	for i, _tgt := range p.PipeDegradedStatusList {
		_src36 := other.PipeDegradedStatusList[i]
		if _tgt != _src36 { return false }
	}
	if len(p.PipeRecentFailureList) != len(other.PipeRecentFailureList) { return false }
...
func (p *TPipeHeartbeatResp) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TPipeHeartbeatResp",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TPipeHeartbeatResp)(nil)

func (p *TPipeHeartbeatResp) Validate() error {
	return nil
}
...
func (p *TLicense) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TLicense",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TLicense)(nil)

func (p *TLicense) Validate() error {
	return nil
}
...
func (p *TLoadSample) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TLoadSample",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TLoadSample)(nil)

func (p *TLoadSample) Validate() error {
	return nil
}
...
func (p *TServiceProvider) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TServiceProvider",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TServiceProvider)(nil)

func (p *TServiceProvider) Validate() error {
	return nil
}
...
func (p *TSender) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
...
var _ slog.LogValuer = (*TSender)(nil)

func (p *TSender) Validate() error {
	return nil
}
...
func (p *TTestConnectionResult_) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TTestConnectionResult_",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TTestConnectionResult_)(nil)

func (p *TTestConnectionResult_) Validate() error {
	return nil
}
...
func (p *TTestConnectionResp) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TTestConnectionResp",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TTestConnectionResp)(nil)

func (p *TTestConnectionResp) Validate() error {
	return nil
}
...
func (p *TNodeLocations) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TNodeLocations",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TNodeLocations)(nil)

func (p *TNodeLocations) Validate() error {
	return nil
}
...
func (p *TExternalServiceListResp) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TExternalServiceListResp",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TExternalServiceListResp)(nil)

func (p *TExternalServiceListResp) Validate() error {
	return nil
}
...
func (p *TExternalServiceEntry) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TExternalServiceEntry",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TExternalServiceEntry)(nil)

func (p *TExternalServiceEntry) Validate() error {
	return nil
}
...
func (p *TShowConfigurationTemplateResp) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TShowConfigurationTemplateResp",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TShowConfigurationTemplateResp)(nil)

func (p *TShowConfigurationTemplateResp) Validate() error {
	return nil
}
...
func (p *TShowConfigurationResp) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TShowConfigurationResp",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TShowConfigurationResp)(nil)

func (p *TShowConfigurationResp) Validate() error {
	return nil
}
...
//  - Data
// 
type TShowAppliedConfigurationsResp struct {
	Status *TSStatus `thrift:"status,1,required" db:"status" json:"status"`
	Data map[string]string `thrift:"data,2" db:"data" json:"data,omitempty"`
}

func NewTShowAppliedConfigurationsResp() *TShowAppliedConfigurationsResp {
	return &TShowAppliedConfigurationsResp{}
}

var TShowAppliedConfigurationsResp_Status_DEFAULT *TSStatus

func (p *TShowAppliedConfigurationsResp) GetStatus() *TSStatus {
	if !p.IsSetStatus() {
		return TShowAppliedConfigurationsResp_Status_DEFAULT
	}
	return p.Status
}

var TShowAppliedConfigurationsResp_Data_DEFAULT map[string]string


func (p *TShowAppliedConfigurationsResp) GetData() map[string]string {
	return p.Data
}

func (p *TShowAppliedConfigurationsResp) IsSetStatus() bool {
	return p.Status != nil
}

func (p *TShowAppliedConfigurationsResp) IsSetData() bool {
	return p.Data != nil
}

func (p *TShowAppliedConfigurationsResp) Read(ctx context.Context, iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(ctx); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *TShowAppliedConfigurationsResp) ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
	p.Status = &TSStatus{}
	if err := p.Status.Read(ctx, iprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Status), err)
	}
...
func (p *TShowAppliedConfigurationsResp) ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
	_, _, size, err := iprot.ReadMapBegin(ctx)
	if err != nil {
		return thrift.PrependError("error reading map begin: ", err)
	}
...
func (p *TShowAppliedConfigurationsResp) Write(ctx context.Context, oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin(ctx, "TShowAppliedConfigurationsResp"); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err)
	}
	if p != nil {
		if err := p.writeField1(ctx, oprot); err != nil { return err }
...
func (p *TShowAppliedConfigurationsResp) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin(ctx, "status", thrift.STRUCT, 1); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:status: ", p), err)
	}
	if err := p.Status.Write(ctx, oprot); err != nil {
...
func (p *TShowAppliedConfigurationsResp) writeField2(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if p.IsSetData() {
...
func (p *TShowAppliedConfigurationsResp) Equals(other *TShowAppliedConfigurationsResp) bool {
	if p == other {
		return true
	} else if p == nil || other == nil {
		return false
...
func (p *TShowAppliedConfigurationsResp) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("TShowAppliedConfigurationsResp(%+v)", *p)
}

func (p *TShowAppliedConfigurationsResp) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*common.TShowAppliedConfigurationsResp",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*TShowAppliedConfigurationsResp)(nil)

func (p *TShowAppliedConfigurationsResp) Validate() error {
	return nil
}
